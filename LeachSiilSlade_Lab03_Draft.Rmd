...
Our **research question** is the following: _Should our candidate support a traditional "Tough on Crime" platform? _
...
model2_no_minorityvariable <- with(crime_na, lm(crmrte ~ polpc+prbarr+prbconv+prbpris+avgsen+log(taxpc, base = 10)+density+govt_wg+pctymle))
